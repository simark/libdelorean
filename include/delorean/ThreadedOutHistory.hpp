...
#include "AbstractThreadedHistory.hpp"
...
class ThreadedOutHistory : virtual public OutHistory, virtual public AbstractThreadedHistory
{
public:
	ThreadedOutHistory(unsigned int maxQueueSize = 10000);
	ThreadedOutHistory(HistoryConfig config, unsigned int maxQueueSize = 10000);
	virtual void open();
